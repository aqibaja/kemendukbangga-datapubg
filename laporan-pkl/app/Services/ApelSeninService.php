...
class ApelSeninService
{
    ...
    public static array $teamMembers = [
        ...
        'PENGELOLAAN MANAJEMEN KINERJA' => [
            'AMRIZAL, S.H., M.H.', 'ARIFA ZAHRA, S. IP', 'EARLY PROPHITA, S. PSI, MM', 'FAHMI, SE', 'FENNY SILFIA PUTRI, SE, M. SI', 'FITA RONAYA, SH', 'JUNI MAHZUR, S. SOS, M. SI', 'M. ZAIN', 'MAYA ZATIL AQMAR, SE', 'RIFKI KHAIRUL AMRI, SE', 'SURYA RIZKY, S.I.KOM'
        ],
        'UMUM, HUMAS, DAN PROTOKOL' => [
            'AGUS MIDARLI', 'AIDIL FITARSYAH', 'ALISSA SHAFIRA AYUWI, S. IP', 'ARMIADI', 'AZHAR, SE', 'AZHARI', 'BAHRI ASMAWI, SE', 'CUT ROSA MINORA, SE', 'DENI NURFANDI', 'EDDY MUNAWAR, ST, M. SI', 'FAHRI MA\'RUF, S.A.P', 'FREDY, S. PD', 'HANIFAH, SE', 'ICHYA ULUMIDDIN', 'IRMAWATI, S. FARM', 'JOPI DIAN SAPUTRA, SE, S. SOS', 'KHALIS', 'MAULIDI', 'MUHAMMAD', 'MUHAMMAD IQBAL', 'MURTAZA', 'NIKMATUL AKBAR, S. AK, MAP', 'NOVI MAULINA, A. MD', 'NURHAFIZAH, A. MD', 'NURMIATI, SE', 'RAHMATSYAH, SE', 'RATNA YUSA DEWI', 'RIO HUSNADI', 'RIZAL SYAHPUTRA', 'RIZQA ANDRIANI LUBIS, S.I.KOM', 'RONA VITRYA', 'SRI RAIHAN, S. PD, MAP', 'SUNARTI', 'TEUKU MUHAMMAD NASIR', 'WIDIA GUSTIASARI, SKM', 'YORA MUNIRAH, S.I.KOM', 'YOVANDI FEBRIANSYAH', 'ZARRA SILVIA BALQIS, S. SOS', 'ZULFADHLI, SE', 'ZULFIKAR, SE'
        ],
        'DATA DAN INFORMASI' => [
    ...
    /**
     * Mengambil daftar semua anggota tim dari array timKerja.
     * Mengembalikan array 1 dimensi berisi nama anggota.
     */
    public function getAllTeamMembers()
    {
        $allMembers = [];
        foreach (array_keys(self::$timKerja) as $team) {
            $members = self::getTeamMembers($team);
