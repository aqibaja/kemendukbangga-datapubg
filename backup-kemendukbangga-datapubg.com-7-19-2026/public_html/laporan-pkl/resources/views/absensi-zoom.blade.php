        ...
        @if($tab === 'kegiatan')
            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-8">
                    <!-- Seluruh Data Card -->
                    <a href="{{ route('absensi-zoom.city', ['city' => 'Seluruh Data', 'event' => $selectedEvent]) }}" @click="$dispatch('data-loading')" class="group relative block bg-white/40 backdrop-blur-xl rounded-[2rem] p-1 transition-all duration-500 hover:-translate-y-3 hover:scale-[1.02]">
                        <div class="absolute inset-0 bg-gradient-to-br from-emerald-400 via-green-300 to-teal-500 rounded-[2rem] opacity-20 group-hover:opacity-100 group-hover:blur-md transition-all duration-500"></div>
                        <div class="absolute inset-0 bg-gradient-to-br from-emerald-400 via-green-300 to-teal-500 rounded-[2rem] opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>
                        ...
                        <div class="relative h-full bg-gradient-to-br from-white to-slate-50/90 rounded-[1.85rem] p-6 flex flex-col items-center text-center shadow-xl shadow-slate-200/50">
                            ...
                            <div class="relative w-24 h-24 mb-6">
                                ...
                                <div class="relative bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.08)] w-full h-full flex items-center justify-center p-3 border border-slate-100 transform group-hover:-translate-y-1 transition-transform duration-500 text-emerald-500">
                                    <i class="fas fa-users text-5xl drop-shadow-sm group-hover:scale-110 transition-transform duration-500"></i>
                                </div>
                            </div>
                            
                            <h3 class="text-base font-black text-slate-800 mb-4 line-clamp-2 h-12 flex items-center justify-center group-hover:text-emerald-700 transition-colors tracking-tight">Seluruh Data</h3>
                            ...
                            <div class="mt-auto bg-slate-100 text-slate-600 px-5 py-2.5 rounded-xl text-xs font-bold tracking-wide group-hover:bg-gradient-to-r group-hover:from-emerald-500 group-hover:to-teal-600 group-hover:text-white group-hover:shadow-lg transition-all duration-300 w-full">
                                <span class="text-xl mr-1">{{ array_sum($citiesCount) }}</span> <span class="uppercase tracking-widest text-[10px]">Hadir</span>
                            </div>
                        </div>
                    </a>
